...
static const Key keys[] = {
  ...
  { MODKEY|ControlMask,           XK_s,      spawn,          {.v = rofisshcmd} },
  { Mod1Mask,                     XK_Tab,    spawn,          {.v = rofiwincmd} },
  { MODKEY|ControlMask,           XK_e,      spawn,          {.v = rofiemojicmd} },
  { MODKEY|ControlMask,           XK_c,      spawn,          {.v = roficalccmd} },
  { MODKEY|ControlMask,           XK_p,      spawn,          {.v = rofipwrcmd} },
  { MODKEY|ControlMask,           XK_w,      spawn,          {.v = rofiwificmd} },
